...
class TweakcnShadows extends ThemeExtension<TweakcnShadows> {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TweakcnShadows &&
          listEquals(shadow2xs, other.shadow2xs) &&
          listEquals(shadowXs, other.shadowXs) &&
          listEquals(shadowSm, other.shadowSm) &&
          listEquals(shadow, other.shadow) &&
          listEquals(shadowMd, other.shadowMd) &&
          listEquals(shadowLg, other.shadowLg) &&
          listEquals(shadowXl, other.shadowXl) &&
          listEquals(shadow2xl, other.shadow2xl);
